 ...
 *
 * For each texture view, the function will generate a set of texture patches. The
 * texture patches will then be merged if they contain the same image content. The
 * function will also run hole filling if the corresponding flag is set.
 *
 * @param graph The graph containing the face labels.
 * @param mesh The triangle mesh.
 * @param mesh_info The mesh information.
 * @param texture_views The texture views.
 * @param settings The settings.
 * @param vertex_projection_infos The vertex projection information.
 * @param texture_patches The texture patches.
 */
void
