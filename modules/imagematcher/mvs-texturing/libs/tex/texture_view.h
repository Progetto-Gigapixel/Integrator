...
TextureView::inside(math::Vec3f const & v1, math::Vec3f const & v2, math::Vec3f const & v3) const {
    ...
    return valid_pixel(p1) && valid_pixel(p2) && valid_pixel(p3);
        ...
        /**
         * Calculates the pixel coordinates of a 3D vertex in the view.
         * \param[in] vertex a 3D vertex
         * \return the pixel coordinates of the vertex
         */
inline math::Vec2f
TextureView::get_pixel_coords(math::Vec3f const & vertex) const {
    math::Vec3f cam_point= world_to_cam.mult(vertex, 1.0f); 
