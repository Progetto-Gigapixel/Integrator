...
TextureView::TextureView(std::size_t id, mve::CameraInfo const & camera,
    ...
    try {
       ...
       header = load_tiff_file_headers(image_file); 
        //qua esplode la libreria
...
ImageHeaders TextureView::load_tiff_file_headers(std::string const &filename) {
    tex::ImageHeaders headers;
