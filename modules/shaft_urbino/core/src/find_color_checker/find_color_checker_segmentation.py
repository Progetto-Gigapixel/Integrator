...
class FindColorCheckerSegmentation:
    ...
    def find(self, image_array):
        ...
        if not self.color_checker_data:
            ...
            cropped_colour_checker_image = color_checker_data.colour_checker
            original_height, original_width = image_array.shape[:2]
            target_height, target_width = cropped_colour_checker_image.shape[:2]
            ...
            # Prepare the data
            self._prepare_data(color_checker_data, absolute_patch_coordinates, rgb)
        ...
        return self.color_checker_data #, self.cropped_image
    ...
    def _prepare_data(self, detected_checkers, patch_positions, patch_rgbs):
        """
        ...
        checker_info = []
        for swatch_idx, (rgb, position) in enumerate(zip(patch_rgbs, patch_positions)):
            patch_info = {
